...
@pytest.mark.parametrize('test_input_number,expected_result', [
    ...
    (349, (3, '7337')),
    (196, None),
    (10677, (53, '4668731596684224866951378664')),
    (4994, None),
])
def test_get_number_iterations_to_palindrome(test_input_number, expected_result):
    # arrange
    from src.p055_lychrel_numbers import get_number_iterations_to_palindrome

    # act
    actual_result = get_number_iterations_to_palindrome(test_input_number, 100)
